...
import { ArrowLeft, ShieldAlert, CheckCircle2, XCircle, AlertTriangle, TrendingUp, Building2, FileText, Users, FileCheck, ClipboardList } from "lucide-react"
    ...
    <div className="min-h-screen bg-background p-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="w-full">
          ...
          <TabsTrigger value="bid" className="flex-1">Bid</TabsTrigger>
          <TabsTrigger value="doc" className="flex-1">Doc</TabsTrigger>
          {contract.alert_report && (
            <TabsTrigger value="coa" className="flex-1">COA Report</TabsTrigger>
          )}
        </TabsList>
