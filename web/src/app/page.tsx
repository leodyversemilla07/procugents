...
export default function Dashboard() {
	...
	const [liveStatus, setLiveStatus] = useState<"offline" | "reconnecting" | "live">("offline");
			...
			<Card className="mb-8">
				...
				<CardContent>
					<div className="flex items-center gap-4">
						...
						{crawlStatus && <span className="text-sm text-muted-foreground">{crawlStatus}</span>}
				...
				<Alert className="mb-6 border-destructive/50 bg-destructive/10">
					...
					<AlertDescription className="flex items-center justify-between gap-4">
						<span>
							...
							{latestAlert.description} ({latestAlert.agency || "agency n/a"})
									...
									{paginatedAnalyses.map((a) => (
										<TableRow key={a.id}>
											...
											<TableCell>
												<Badge
													variant={
														a.final_risk_score >= 4
															? "destructive"
															: a.final_risk_score >= 3
																? "secondary"
																: "outline"
													}
													className="font-mono"
