                ...
                <TableBody>
                  {alerts.map((a) => (
                    <TableRow key={a.id}>
                      ...
                      <TableCell className="font-medium max-w-[300px] truncate" title={a.description || a.title}>
                        {a.title}
                      </TableCell>
                      <TableCell>
                        <Badge variant={Severity.tone(a.severity)}>
                          {a.severity}
                        </Badge>
                      </TableCell>
                      <TableCell>
                    ...
                    <div className="space-y-4 py-4">
                      ...
                      {resolveTarget.description && (
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">{resolveTarget.description}</p>
                        </div>
                      )}
